...
export class NgDocApiPageEntity extends NgDocRouteEntity<never> {
  ...
  private updateDeclaration(): asserts this is this & { declaration: NgDocSupportedDeclaration } {
    const declarations: NgDocSupportedDeclaration[] = [
    ...
    this.declaration = declarations.find(
      (declaration: NgDocSupportedDeclaration) => declaration.getName() === this.declarationName,
    );
