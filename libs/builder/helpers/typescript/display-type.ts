 ...
 */
export function displayType(node: Node, typeFormatFlags: TypeFormatFlags = TypeFormatFlags.NoTruncation): string {
 ...
 * @param typeFormatFlags
 */
export function displayReturnType(node: Node, typeFormatFlags: TypeFormatFlags = TypeFormatFlags.NoTruncation): string {
