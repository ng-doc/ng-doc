...
describe('declarationFolderName', () => {
	...
	it('should return the folder name for classes', () => {
		const sourceFile = project.createSourceFile('class.ts', `
			export class Test {}
		`);
	...
	it('should return the folder name for interfaces', () => {
		const sourceFile = project.createSourceFile('interface.ts', `
	...
	it('should return the folder name for enums', () => {
		const sourceFile = project.createSourceFile('enum.ts', `
			export enum Test {}
		`);
	...
	it('should return the folder name for type aliases', () => {
		const sourceFile = project.createSourceFile('type-alias.ts', `
	...
	it('should return the folder name for functions', () => {
		const sourceFile = project.createSourceFile('function.ts', `
	...
	it('should return the folder name for variables', () => {
		const sourceFile = project.createSourceFile('variable.ts', `
			export const test = '';
		`);
	...
	it('should return the folder name for unknowns', () => {
		const sourceFile = project.createSourceFile('unknown.ts', `
			export class Test {
				method() {}
			}
		`);
		...
		expect(declarationFolderName(declaration.getMethodOrThrow('method') as unknown as ExportedDeclarations))
			.toBe('unknowns');
	})
})
