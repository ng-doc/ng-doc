...
.ng-doc`);
	...
	it('should add NgDoc modules', async () => {
		...
		expect(tree.readContent('test/app/app.module.ts'))
			.toEqual(`import { NgDocRootComponent, NgDocNavbarComponent, NgDocSidebarComponent, provideSearchEngine, NgDocDefaultSearchEngine, providePageSkeleton, NG_DOC_DEFAULT_PAGE_SKELETON, providePageProcessor, NG_DOC_DEFAULT_PAGE_PROCESSORS } from "@ng-doc/app";
